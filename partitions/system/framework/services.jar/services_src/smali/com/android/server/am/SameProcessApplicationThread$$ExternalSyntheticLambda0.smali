...
.method public final run()V
    ...
    iget-object v1, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$1:Landroid/content/Intent;

    iget-object v2, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$2:Landroid/content/pm/ActivityInfo;

    iget-object v3, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$3:Landroid/content/res/CompatibilityInfo;

    iget v4, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$4:I

    iget-object v5, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$5:Ljava/lang/String;

    iget-object v6, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$6:Landroid/os/Bundle;

    iget-boolean v7, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$7:Z

    iget-boolean v8, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$8:Z

    iget v9, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$9:I

    iget v10, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$10:I

    iget v11, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$11:I

    iget-object v12, p0, Lcom/android/server/am/SameProcessApplicationThread$$ExternalSyntheticLambda0;->f$12:Ljava/lang/String;

    invoke-static/range {v0 .. v12}, Lcom/android/server/am/SameProcessApplicationThread;->$r8$lambda$lecB6zzqPsQtQaMq8sf-x89orFw(Lcom/android/server/am/SameProcessApplicationThread;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Landroid/content/res/CompatibilityInfo;ILjava/lang/String;Landroid/os/Bundle;ZZIIILjava/lang/String;)V
