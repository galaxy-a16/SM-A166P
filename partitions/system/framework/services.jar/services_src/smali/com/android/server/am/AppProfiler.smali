...
.field public mLastActivityLaunchedTime:J
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/os/Looper;Lcom/android/server/am/LowMemDetector;)V
    ...
    iput-wide v0, p0, Lcom/android/server/am/AppProfiler;->mLastActivityLaunchedTime:J
...
.method public final collectPssInBackground()V
    ...
    iget-object v6, v10, Lcom/android/server/am/ProcessProfileRecord;->mApp:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v6}, Lcom/android/server/am/ProcessCachedOptimizerRecord;->skipPSSCollectionBecauseFrozen()Z
    ...
    iget-object v8, v10, Lcom/android/server/am/ProcessProfileRecord;->mApp:Lcom/android/server/am/ProcessRecord;

    iget v8, v8, Lcom/android/server/am/ProcessRecord;->uid:I

    invoke-virtual {v6, v8}, Lcom/android/server/am/ActivityManagerService;->isCameraActiveForUid(I)Z
    ...
    :cond_a
    invoke-static {v11, v14, v13}, Landroid/os/Debug;->getPss(I[J[J)J
    ...
    :goto_9
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/ProcessProfileRecord;->abortNextPssTime()V
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/ProcessProfileRecord;->getThread()Landroid/app/IApplicationThread;

    move-result-object v2

    if-eqz v2, :cond_e

    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/ProcessProfileRecord;->getSetProcState()I

    move-result v2

    if-ne v2, v0, :cond_e

    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/ProcessProfileRecord;->getPid()I
...
.method public final recordPssSampleLPf(Lcom/android/server/am/ProcessProfileRecord;IJJJJIJJ)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/chimera/ChimeraManagerService;->checkProcessInHeimdall(ILjava/lang/String;Ljava/lang/String;)V
...
.method public final scheduleTrimMemoryLSP(Lcom/android/server/am/ProcessRecord;ILjava/lang/String;)V
    ...
    iget-wide v4, p0, Lcom/android/server/am/AppProfiler;->mLastActivityLaunchedTime:J
