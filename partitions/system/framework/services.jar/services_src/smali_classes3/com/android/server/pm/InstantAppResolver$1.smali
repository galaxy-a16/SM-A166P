...
.method public onPhaseTwoResolved(Ljava/util/List;J)V
    ...
    iget-object v2, v0, Lcom/android/server/pm/InstantAppResolver$1;->val$token:Ljava/lang/String;

    iget-object v3, v0, Lcom/android/server/pm/InstantAppResolver$1;->val$requestObj:Landroid/content/pm/InstantAppRequest;

    iget-object v3, v3, Landroid/content/pm/InstantAppRequest;->responseObj:Landroid/content/pm/AuxiliaryResolveInfo;

    iget-object v3, v3, Landroid/content/pm/AuxiliaryResolveInfo;->filters:Ljava/util/List;
    ...
    invoke-static {v4, v5, v6, v2, v3}, Lcom/android/server/pm/InstantAppResolver;->-$$Nest$smlogMetrics(IJLjava/lang/String;I)V
