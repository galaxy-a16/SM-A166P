...
.method public multMatrix(S[[S)[[S
    ...
    invoke-static {p1, v4}, Lorg/bouncycastle/pqc/crypto/rainbow/util/GF2Field;->multElem(SS)S
...
.method public multiplyMatrix([[S[S)[S
    ...
    invoke-static {v4, v3}, Lorg/bouncycastle/pqc/crypto/rainbow/util/GF2Field;->addElem(SS)S
...
.method public solveEquation([[S[S)[S
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/crypto/rainbow/util/ComputeInField;->x:[S
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
