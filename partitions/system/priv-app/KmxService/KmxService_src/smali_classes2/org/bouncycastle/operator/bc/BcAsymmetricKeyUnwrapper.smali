...
.method public generateUnwrappedKey(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[B)Lorg/bouncycastle/operator/GenericKey;
    ...
    iget-object p0, p0, Lorg/bouncycastle/operator/bc/BcAsymmetricKeyUnwrapper;->privateKey:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    const/4 v1, 0x0

    invoke-interface {v0, v1, p0}, Lorg/bouncycastle/crypto/AsymmetricBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V

    :try_start_0
    array-length p0, p2

    invoke-interface {v0, p2, v1, p0}, Lorg/bouncycastle/crypto/AsymmetricBlockCipher;->processBlock([BII)[B
