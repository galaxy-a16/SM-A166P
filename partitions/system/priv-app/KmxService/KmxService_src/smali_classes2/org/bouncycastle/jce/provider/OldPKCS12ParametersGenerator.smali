...
.method private generateDerivedKey(II)[B
    ...
    invoke-interface {v12, v11, v3}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    invoke-interface {v12, v11, v3, v10}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-direct {p0, v7, v8, v6}, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->adjust([BI[B)V
