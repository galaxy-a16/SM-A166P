...
.method private createGeneralizedTime(Ljava/util/Date;)Lorg/bouncycastle/asn1/ASN1GeneralizedTime;
    ...
    iget p0, p0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->resolution:I
    ...
    invoke-direct {p1, p0}, Lorg/bouncycastle/tsp/TSPException;-><init>(Ljava/lang/String;)V
...
.method public addAttributeCertificates(Lorg/bouncycastle/util/Store;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->attrCerts:Ljava/util/List;
...
.method public addCRLs(Lorg/bouncycastle/util/Store;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->crls:Ljava/util/List;
...
.method public addCertificates(Lorg/bouncycastle/util/Store;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->certs:Ljava/util/List;
...
.method public addOtherRevocationInfo(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Lorg/bouncycastle/util/Store;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->otherRevoc:Ljava/util/Map;
...
.method public generate(Lorg/bouncycastle/tsp/TimeStampRequest;Ljava/math/BigInteger;Ljava/util/Date;Lorg/bouncycastle/asn1/x509/Extensions;)Lorg/bouncycastle/tsp/TimeStampToken;
    ...
    iget v3, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->accuracySeconds:I

    const/4 v4, 0x0

    if-gtz v3, :cond_1

    iget v5, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->accuracyMillis:I

    if-gtz v5, :cond_1

    iget v5, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->accuracyMicros:I
    ...
    :goto_1
    iget v3, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->accuracyMillis:I
    ...
    :goto_2
    iget v3, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->accuracyMicros:I
    ...
    :goto_4
    iget-boolean v3, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->ordering:Z
    ...
    :goto_6
    iget-object v3, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->tsaPolicyOID:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :goto_9
    iget v2, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->resolution:I

    if-nez v2, :cond_c

    iget-object v2, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->locale:Ljava/util/Locale;

    if-nez v2, :cond_b

    new-instance v2, Lorg/bouncycastle/asn1/ASN1GeneralizedTime;

    invoke-direct {v2, v1}, Lorg/bouncycastle/asn1/ASN1GeneralizedTime;-><init>(Ljava/util/Date;)V
    ...
    invoke-direct {v3, v1, v2}, Lorg/bouncycastle/asn1/ASN1GeneralizedTime;-><init>(Ljava/util/Date;Ljava/util/Locale;)V
    ...
    :cond_c
    invoke-direct {v0, v1}, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->createGeneralizedTime(Ljava/util/Date;)Lorg/bouncycastle/asn1/ASN1GeneralizedTime;
    ...
    iget-object v14, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->tsa:Lorg/bouncycastle/asn1/x509/GeneralName;
    ...
    iget-object v4, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->certs:Ljava/util/List;
    ...
    iget-object v4, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->attrCerts:Ljava/util/List;
    ...
    iget-object v4, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->crls:Ljava/util/List;

    invoke-direct {v3, v4}, Lorg/bouncycastle/util/CollectionStore;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v2, v3}, Lorg/bouncycastle/cms/CMSSignedGenerator;->addCRLs(Lorg/bouncycastle/util/Store;)V

    iget-object v3, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->otherRevoc:Ljava/util/Map;
    ...
    iget-object v6, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->otherRevoc:Ljava/util/Map;
    ...
    :cond_e
    iget-object v0, v0, Lorg/bouncycastle/tsp/TimeStampTokenGenerator;->signerInfoGen:Lorg/bouncycastle/cms/SignerInfoGenerator;

    invoke-virtual {v2, v0}, Lorg/bouncycastle/cms/CMSSignedGenerator;->addSignerInfoGenerator(Lorg/bouncycastle/cms/SignerInfoGenerator;)V
    ...
    invoke-virtual {v2, v1, v0}, Lorg/bouncycastle/cms/CMSSignedDataGenerator;->generate(Lorg/bouncycastle/cms/CMSTypedData;Z)Lorg/bouncycastle/cms/CMSSignedData;
