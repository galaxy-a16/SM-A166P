...
.method public constructor <init>(Ljava/io/InputStream;Lorg/spongycastle/openpgp/operator/KeyFingerPrintCalculator;)V
    ...
    invoke-static {p1}, Lorg/spongycastle/openpgp/PGPKeyRing;->wrap(Ljava/io/InputStream;)Lorg/spongycastle/bcpg/BCPGInputStream;
    ...
    const-string p2, "public key ring doesn\'t start with public key tag: tag 0x"
    ...
    check-cast v4, Lorg/spongycastle/bcpg/PublicKeyPacket;

    invoke-static {p1}, Lorg/spongycastle/openpgp/PGPKeyRing;->readOptionalTrustPacket(Lorg/spongycastle/bcpg/BCPGInputStream;)Lorg/spongycastle/bcpg/TrustPacket;

    move-result-object v5

    invoke-static {p1}, Lorg/spongycastle/openpgp/PGPKeyRing;->readSignaturesAndTrust(Lorg/spongycastle/bcpg/BCPGInputStream;)Ljava/util/List;
    ...
    invoke-static {p1, v7, v8, v9}, Lorg/spongycastle/openpgp/PGPKeyRing;->readUserIDs(Lorg/spongycastle/bcpg/BCPGInputStream;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct/range {v3 .. v10}, Lorg/spongycastle/openpgp/PGPPublicKey;-><init>(Lorg/spongycastle/bcpg/PublicKeyPacket;Lorg/spongycastle/bcpg/TrustPacket;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lorg/spongycastle/openpgp/operator/KeyFingerPrintCalculator;)V
...
.method public static readSubkey(Lorg/spongycastle/bcpg/BCPGInputStream;Lorg/spongycastle/openpgp/operator/KeyFingerPrintCalculator;)Lorg/spongycastle/openpgp/PGPPublicKey;
    .locals 3
...
.method public encode(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p0, p1, v0}, Lorg/spongycastle/openpgp/PGPPublicKeyRing;->encode(Ljava/io/OutputStream;Z)V
...
.method public encode(Ljava/io/OutputStream;Z)V
    ...
    invoke-virtual {v1, p1, p2}, Lorg/spongycastle/openpgp/PGPPublicKey;->encode(Ljava/io/OutputStream;Z)V
...
.method public getEncoded(Z)[B
    ...
    invoke-virtual {p0, v0, p1}, Lorg/spongycastle/openpgp/PGPPublicKeyRing;->encode(Ljava/io/OutputStream;Z)V
...
.method public getKeysWithSignaturesBy(J)Ljava/util/Iterator;
    ...
    :goto_0
    iget-object v2, p0, Lorg/spongycastle/openpgp/PGPPublicKeyRing;->keys:Ljava/util/List;
    ...
    invoke-virtual {v2, p1, p2}, Lorg/spongycastle/openpgp/PGPPublicKey;->getSignaturesForKeyID(J)Ljava/util/Iterator;
...
.method public getPublicKey()Lorg/spongycastle/openpgp/PGPPublicKey;
    ...
    check-cast p0, Lorg/spongycastle/openpgp/PGPPublicKey;
