...
.method private doDigestFunction(Lorg/spongycastle/est/ESTResponse;)Lorg/spongycastle/est/ESTResponse;
    ...
    :try_start_0
    invoke-virtual {v1, v2}, Lorg/spongycastle/est/ESTResponse;->getHeader(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v3, v5}, Lorg/spongycastle/est/HttpUtil;->splitCSL(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-direct {v0, v1}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lorg/spongycastle/est/HttpAuth;->realm:Ljava/lang/String;
    ...
    iget-object v0, v0, Lorg/spongycastle/est/HttpAuth;->realm:Ljava/lang/String;
    ...
    invoke-direct {v1, v0, v12, v2, v12}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    :cond_8
    invoke-direct {v0, v11}, Lorg/spongycastle/est/HttpAuth;->lookupDigest(Ljava/lang/String;)Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-direct {v0, v11, v1}, Lorg/spongycastle/est/HttpAuth;->getDigestCalculator(Ljava/lang/String;Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;)Lorg/spongycastle/operator/DigestCalculator;
    ...
    invoke-direct {v0, v14}, Lorg/spongycastle/est/HttpAuth;->makeNonce(I)Ljava/lang/String;

    move-result-object v14

    move-object/from16 v20, v9

    iget-object v9, v0, Lorg/spongycastle/est/HttpAuth;->username:Ljava/lang/String;

    invoke-direct {v0, v12, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    const-string v9, ":"

    invoke-direct {v0, v12, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v8}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    move-object/from16 v21, v6

    iget-object v6, v0, Lorg/spongycastle/est/HttpAuth;->password:[C

    invoke-direct {v0, v12, v6}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;[C)V
    ...
    invoke-direct {v0, v12, v6}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v10}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v14}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v12, v5}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v12, v2}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v7, v6}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v7, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v7, v10}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v7, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    if-eqz v8, :cond_c

    invoke-direct {v0, v7, v5}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    :cond_c
    invoke-direct {v0, v7, v12}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v7, v9}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    invoke-direct {v0, v7, v14}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v7, v8}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V

    goto :goto_6

    :cond_d
    invoke-direct {v0, v7, v13}, Lorg/spongycastle/est/HttpAuth;->update(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    iget-object v7, v0, Lorg/spongycastle/est/HttpAuth;->username:Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lorg/spongycastle/est/HttpAuth;->makeNonce(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lorg/spongycastle/est/ESTRequestBuilder;->withHijacker(Lorg/spongycastle/est/ESTHijacker;)Lorg/spongycastle/est/ESTRequestBuilder;
    ...
    invoke-virtual {v0, v1, v2}, Lorg/spongycastle/est/ESTRequestBuilder;->setHeader(Ljava/lang/String;Ljava/lang/String;)Lorg/spongycastle/est/ESTRequestBuilder;
    ...
    invoke-interface {v1, v0}, Lorg/spongycastle/est/ESTClient;->doRequest(Lorg/spongycastle/est/ESTRequest;)Lorg/spongycastle/est/ESTResponse;
    ...
    invoke-direct {v3, v4, v0, v5, v6}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
...
.method private getDigestCalculator(Ljava/lang/String;Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;)Lorg/spongycastle/operator/DigestCalculator;
    ...
    :try_start_0
    iget-object p0, p0, Lorg/spongycastle/est/HttpAuth;->digestCalculatorProvider:Lorg/spongycastle/operator/DigestCalculatorProvider;

    invoke-interface {p0, p2}, Lorg/spongycastle/operator/DigestCalculatorProvider;->get(Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;)Lorg/spongycastle/operator/DigestCalculator;
...
.method private lookupDigest(Ljava/lang/String;)Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
    ...
    :cond_1
    sget-object p0, Lorg/spongycastle/est/HttpAuth;->digestAlgorithmIdentifierFinder:Lorg/spongycastle/operator/DigestAlgorithmIdentifierFinder;

    invoke-interface {p0, p1}, Lorg/spongycastle/operator/DigestAlgorithmIdentifierFinder;->find(Ljava/lang/String;)Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
...
.method private makeNonce(I)Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/spongycastle/est/HttpAuth;->nonceGenerator:Ljava/security/SecureRandom;
