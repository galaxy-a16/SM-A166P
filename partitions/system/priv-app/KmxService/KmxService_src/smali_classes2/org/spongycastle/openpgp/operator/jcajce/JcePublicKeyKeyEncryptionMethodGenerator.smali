...
.method public encryptSessionInfo(Lorg/spongycastle/openpgp/PGPPublicKey;[B)[B
    ...
    invoke-static {v2}, Lorg/spongycastle/openpgp/operator/jcajce/JcaJcePGPUtil;->getX9Parameters(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)Lorg/spongycastle/asn1/x9/X9ECParameters;
    ...
    iget-object p0, p0, Lorg/spongycastle/openpgp/operator/jcajce/JcePublicKeyKeyEncryptionMethodGenerator;->random:Ljava/security/SecureRandom;

    const/4 v4, 0x3

    invoke-virtual {v1, v4, p1, p0}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/SecureRandom;)V
    ...
    invoke-direct {p2, v0, p1}, Lorg/spongycastle/asn1/x9/X9ECPoint;-><init>(Lorg/spongycastle/math/ec/ECCurve;[B)V

    invoke-virtual {p2}, Lorg/spongycastle/asn1/x9/X9ECPoint;->getPoint()Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-virtual {p2}, Lorg/spongycastle/bcpg/BCPGObject;->getEncoded()[B
    ...
    invoke-virtual {v0, v3, p1, p0}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/SecureRandom;)V
    ...
    const-string v0, "unable to set up ephemeral keys: "
    ...
    const-string v0, "unable to encode MPI: "
