...
.method private generateDerivedKey(II)[B
    ...
    :cond_0
    iget-object p1, p0, Lorg/spongycastle/crypto/PBEParametersGenerator;->salt:[B
    ...
    :cond_2
    iget-object p1, p0, Lorg/spongycastle/crypto/PBEParametersGenerator;->password:[B
    ...
    iget-object v8, p0, Lorg/spongycastle/crypto/PBEParametersGenerator;->password:[B
    ...
    iget-object v12, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v12, v1, v3, v0}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    iget-object v12, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v12, v7, v3, p1}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    iget-object v12, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v12, v11, v3}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I

    :goto_4
    iget v12, p0, Lorg/spongycastle/crypto/PBEParametersGenerator;->iterationCount:I

    if-eq v8, v12, :cond_5

    iget-object v12, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v12, v11, v3, v10}, Lorg/spongycastle/crypto/Digest;->update([BII)V
    ...
    invoke-direct {p0, v7, v8, v6}, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->adjust([BI[B)V
    ...
    invoke-static {v11, v8, v2, v10, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v11, v3, v2, v8, v10}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
