...
.method public closeInput()V
    ...
    :cond_1
    new-instance p0, Lorg/spongycastle/crypto/tls/TlsNoCloseNotifyException;

    invoke-direct {p0}, Lorg/spongycastle/crypto/tls/TlsNoCloseNotifyException;-><init>()V
...
.method public handleAlertMessage(SS)V
    ...
    new-instance p0, Lorg/spongycastle/crypto/tls/TlsFatalAlertReceived;

    invoke-direct {p0, p2}, Lorg/spongycastle/crypto/tls/TlsFatalAlertReceived;-><init>(S)V
...
.method public offerInput([B)V
    ...
    iget-short p0, p0, Lorg/spongycastle/crypto/tls/TlsProtocol;->connection_state:S
...
.method public processRecord(S[BII)V
    ...
    iget-object p0, p0, Lorg/spongycastle/crypto/tls/TlsProtocol;->handshakeQueue:Lorg/spongycastle/crypto/tls/ByteQueue;

    add-int/2addr p3, p4

    sub-int/2addr p3, p1

    invoke-virtual {p0, p2, p3, p1}, Lorg/spongycastle/crypto/tls/ByteQueue;->addData([BII)V
...
.method public raiseAlertFatal(SLjava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, p1, p2, p3, v1}, Lorg/spongycastle/crypto/tls/RecordStream;->writeRecord(S[BII)V
    :try_end_0
...
.method public safeCheckRecordHeader([B)V
    ...
    invoke-direct {p0, v1, p1}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(SLjava/lang/Throwable;)V
...
.method public safeReadRecord()V
    ...
    invoke-direct {p0, v1, v2}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(SLjava/lang/Throwable;)V
...
.method public setAppDataSplitMode(I)V
    ...
    const-string v0, "Illegal appDataSplitMode mode: "
