...
.method public constructor <init>(Lorg/spongycastle/crypto/tls/TlsContext;Lorg/spongycastle/crypto/modes/AEADBlockCipher;Lorg/spongycastle/crypto/modes/AEADBlockCipher;III)V
    ...
    invoke-direct {v15, v11, v14, v4}, Lorg/spongycastle/crypto/params/KeyParameter;-><init>([BII)V

    add-int/2addr v14, v4

    add-int v4, v14, v6

    invoke-static {v11, v14, v4}, Lorg/spongycastle/util/Arrays;->copyOfRange([BII)[B

    move-result-object v14

    add-int v8, v4, v6

    invoke-static {v11, v4, v8}, Lorg/spongycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-direct {v2, v15, v4, v1}, Lorg/spongycastle/crypto/params/AEADParameters;-><init>(Lorg/spongycastle/crypto/params/KeyParameter;I[B)V
...
.method public decodeCiphertext(JS[BII)[B
    ...
    invoke-virtual {v0, v4}, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->getPlaintextLimit(I)I
    ...
    iget v7, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->record_iv_length:I

    add-int/2addr v6, v7

    new-array v7, v6, [B

    iget v8, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->nonceMode:I
    ...
    invoke-static {v1, v2, v7, v6}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V

    move v5, v11

    :goto_0
    iget-object v6, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->decryptImplicitNonce:[B
    ...
    invoke-interface {v3, v15}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->getOutputSize(I)I
    ...
    invoke-virtual {v0, v1, v2, v5, v3}, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B
    ...
    invoke-direct {v2, v6, v5, v7, v1}, Lorg/spongycastle/crypto/params/AEADParameters;-><init>(Lorg/spongycastle/crypto/params/KeyParameter;I[B[B)V
    ...
    invoke-interface {v1, v11, v2}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->init(ZLorg/spongycastle/crypto/CipherParameters;)V

    iget-object v12, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/spongycastle/crypto/modes/AEADBlockCipher;
    ...
    invoke-interface {v0, v4, v1}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
...
.method public encodePlaintext(JS[BII)[B
    ...
    iget v6, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->record_iv_length:I

    add-int/2addr v5, v6

    new-array v6, v5, [B

    iget v7, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->nonceMode:I
    ...
    invoke-static {p1, p2, v6, v3}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V

    move v3, v10

    :goto_0
    iget-object v7, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->encryptImplicitNonce:[B
    ...
    invoke-virtual {p0, p1, p2, v3, v4}, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B
    ...
    invoke-direct {v2, v5, v3, v6, v1}, Lorg/spongycastle/crypto/params/AEADParameters;-><init>(Lorg/spongycastle/crypto/params/KeyParameter;I[B[B)V
    ...
    invoke-interface {v1, v9, v2}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    iget-object v0, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->encryptCipher:Lorg/spongycastle/crypto/modes/AEADBlockCipher;

    invoke-interface {v0, v12, v7}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
    ...
    invoke-direct {v1, v8, v0}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(SLjava/lang/Throwable;)V
