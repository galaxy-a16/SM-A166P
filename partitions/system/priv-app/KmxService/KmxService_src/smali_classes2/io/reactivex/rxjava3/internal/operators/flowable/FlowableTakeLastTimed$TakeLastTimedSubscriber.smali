...
# direct methods
.method public constructor <init>(Lvc/c;JJLjava/util/concurrent/TimeUnit;Ljb/q;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lvc/c;
    ...
    iput-object p7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Ljb/q;

    new-instance p1, Lio/reactivex/rxjava3/operators/g;

    invoke-direct {p1, p8}, Lio/reactivex/rxjava3/operators/g;-><init>(I)V

    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lvc/d;
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;
...
.method public checkTerminated(ZLvc/c;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-interface {p2, p0}, Lvc/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p2, p3}, Lvc/c;->onError(Ljava/lang/Throwable;)V
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lvc/c;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;
    ...
    invoke-virtual {v1}, Lio/reactivex/rxjava3/operators/g;->isEmpty()Z

    move-result v5

    invoke-virtual {p0, v5, v0, v2}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLvc/c;Z)Z
    ...
    :goto_0
    invoke-virtual {v1}, Lio/reactivex/rxjava3/operators/g;->peek()Ljava/lang/Object;
    ...
    :goto_1
    invoke-virtual {p0, v11, v0, v2}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLvc/c;Z)Z
    ...
    invoke-static {v5, v9, v10}, Lh3/a;->H(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    invoke-interface {v0, v11}, Lvc/c;->onNext(Ljava/lang/Object;)V
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Ljb/q;
    ...
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;

    invoke-virtual {p0, v0, v1, v2}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLio/reactivex/rxjava3/operators/g;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Ljb/q;
    ...
    invoke-virtual {v0, v3, p1}, Lio/reactivex/rxjava3/operators/g;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    invoke-virtual {p0, v1, v2, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLio/reactivex/rxjava3/operators/g;)V
...
.method public onSubscribe(Lvc/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lvc/d;
...
.method public trim(JLio/reactivex/rxjava3/operators/g;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    :goto_0
    invoke-virtual {p3}, Lio/reactivex/rxjava3/operators/g;->isEmpty()Z

    move-result v5

    if-nez v5, :cond_3

    invoke-virtual {p3}, Lio/reactivex/rxjava3/operators/g;->peek()Ljava/lang/Object;
    ...
    iget-object v5, p3, Lio/reactivex/rxjava3/operators/g;->h:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :goto_1
    iget-object v8, p3, Lio/reactivex/rxjava3/operators/g;->a:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :cond_2
    :goto_2
    invoke-virtual {p3}, Lio/reactivex/rxjava3/operators/g;->poll()Ljava/lang/Object;
