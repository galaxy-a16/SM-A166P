...
.method public constructor <init>(Lvc/c;Lgb/h;Lgb/h;Lgb/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lvc/c;
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->leftEnd:Lgb/h;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->rightEnd:Lgb/h;

    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->resultSelector:Lgb/c;
...
.method public cancel()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->queue:Lio/reactivex/internal/queue/b;
...
.method public cancelAll()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->disposables:Lio/reactivex/disposables/a;
...
.method public drain()V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lvc/c;
    ...
    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lvc/c;)V
    ...
    const-string v12, "Could not emit value due to lack of requests"

    const-string v13, "The resultSelector returned a null value"
    ...
    :try_start_0
    iget-object v7, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->leftEnd:Lgb/h;

    invoke-interface {v7, v5}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v9, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->resultSelector:Lgb/c;

    invoke-interface {v9, v5, v0}, Lgb/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    invoke-static {v0, v13}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-direct {v4, v12}, Lio/reactivex/exceptions/MissingBackpressureException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Lvc/c;Lib/g;)V
    ...
    :try_start_2
    iget-object v7, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->rightEnd:Lgb/h;
    ...
    invoke-interface {v9, v8, v5}, Lgb/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v8

    invoke-static {v8, v13}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_3
    ...
    invoke-static {v0, v5, v6}, Lh3/a;->G(Ljava/util/concurrent/atomic/AtomicLong;J)V
...
.method public fail(Ljava/lang/Throwable;Lvc/c;Lib/g;)V
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lvc/c;)V
