...
# direct methods
.method public constructor <init>(Lib/a;Ljava/util/Iterator;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lib/a;
...
.method public fastPath()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lib/a;
    ...
    :cond_3
    invoke-interface {v1, v2}, Lib/a;->tryOnNext(Ljava/lang/Object;)Z
...
.method public slowPath(J)V
    ...
    :cond_4
    invoke-interface {v1, v6}, Lib/a;->tryOnNext(Ljava/lang/Object;)Z
