...
.method public constructor <init>(Leb/n;Lgb/h;Lgb/h;Lgb/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->downstream:Leb/n;
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->leftEnd:Lgb/h;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->rightEnd:Lgb/h;

    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->resultSelector:Lgb/c;
...
.method public cancelAll()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->disposables:Lio/reactivex/disposables/a;
...
.method public drain()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->downstream:Leb/n;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->errorAll(Leb/n;)V
    ...
    :try_start_0
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->leftEnd:Lgb/h;

    invoke-interface {v6, v4}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    const-string v7, "The leftEnd returned a null ObservableSource"

    invoke-static {v6, v7}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v7, p0, v2, v5}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/internal/operators/observable/f;ZI)V
    ...
    invoke-interface {v6, v7}, Leb/m;->subscribe(Leb/n;)V
    ...
    :try_start_1
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->resultSelector:Lgb/c;

    invoke-interface {v7, v4, v6}, Lgb/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    invoke-static {v6, v8}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-interface {v1, v6}, Leb/n;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->fail(Ljava/lang/Throwable;Leb/n;Lio/reactivex/internal/queue/b;)V
    ...
    :try_start_2
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->rightEnd:Lgb/h;
    ...
    invoke-static {v7, v9}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v9, p0, v5, v6}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/internal/operators/observable/f;ZI)V

    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->disposables:Lio/reactivex/disposables/a;

    invoke-virtual {v5, v9}, Lio/reactivex/disposables/a;->c(Lio/reactivex/disposables/b;)Z

    invoke-interface {v7, v9}, Leb/m;->subscribe(Leb/n;)V
    ...
    invoke-interface {v7, v6, v4}, Lgb/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public fail(Ljava/lang/Throwable;Leb/n;Lio/reactivex/internal/queue/b;)V
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->errorAll(Leb/n;)V
