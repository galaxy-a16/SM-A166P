...
.method public constructor <init>(Lvc/c;JJI)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lvc/c;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lvc/c;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;
    ...
    check-cast v4, Lio/reactivex/rxjava3/processors/g;

    if-eqz v4, :cond_b

    invoke-virtual {v4}, Lio/reactivex/rxjava3/processors/g;->onComplete()V
    ...
    check-cast v12, Lio/reactivex/rxjava3/processors/g;
    ...
    :cond_4
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->checkTerminated(ZZLvc/c;Lio/reactivex/rxjava3/operators/g;)Z
    ...
    :cond_6
    new-instance v10, Lio/reactivex/rxjava3/internal/operators/flowable/u;

    invoke-direct {v10, v12}, Lio/reactivex/rxjava3/internal/operators/flowable/u;-><init>(Lio/reactivex/rxjava3/processors/g;)V

    invoke-interface {v0, v10}, Lvc/c;->onNext(Ljava/lang/Object;)V

    invoke-virtual {v10}, Lio/reactivex/rxjava3/internal/operators/flowable/u;->d()Z

    move-result v10

    if-eqz v10, :cond_7

    invoke-virtual {v12}, Lio/reactivex/rxjava3/processors/g;->onComplete()V
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->checkTerminated(ZZLvc/c;Lio/reactivex/rxjava3/operators/g;)Z
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, p1}, Lvc/c;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v4, p0}, Lio/reactivex/rxjava3/processors/g;->e(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/processors/g;
    ...
    invoke-interface {v8, p1}, Lvc/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/rxjava3/operators/g;

    invoke-virtual {p1, v4}, Lio/reactivex/rxjava3/operators/g;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lvc/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lvc/d;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lvc/d;

    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lvc/c;
...
.method public run()V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lvc/d;
