...
# direct methods
.method public constructor <init>(Lio/reactivex/rxjava3/operators/a;ILio/reactivex/rxjava3/operators/SpscArrayQueue;Ljb/p;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;-><init>(ILio/reactivex/rxjava3/operators/SpscArrayQueue;Ljb/p;)V

    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lio/reactivex/rxjava3/operators/a;
...
.method public onSubscribe(Lvc/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lvc/d;

    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lio/reactivex/rxjava3/operators/a;

    invoke-interface {v0, p0}, Lvc/c;->onSubscribe(Lvc/d;)V

    iget p0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->prefetch:I
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lio/reactivex/rxjava3/operators/a;
    ...
    invoke-interface {v3, v15}, Lvc/c;->onError(Ljava/lang/Throwable;)V

    :goto_1
    iget-object v0, v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->worker:Ljb/p;
    ...
    :cond_6
    invoke-interface {v3, v15}, Lio/reactivex/rxjava3/operators/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v13, v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lvc/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lvc/d;->request(J)V
    ...
    invoke-interface {v3, v7}, Lvc/c;->onError(Ljava/lang/Throwable;)V
