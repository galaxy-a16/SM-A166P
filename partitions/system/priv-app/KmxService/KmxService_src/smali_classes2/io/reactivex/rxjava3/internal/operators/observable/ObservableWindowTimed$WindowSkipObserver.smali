...
.method public constructor <init>(Ljb/m;JJLjava/util/concurrent/TimeUnit;Ljb/p;I)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p7, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;->worker:Ljb/p;
...
.method public cleanupResources()V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;->worker:Ljb/p;
...
.method public createFirstWindow()V
    ...
    invoke-direct {v1, v0}, Lio/reactivex/rxjava3/internal/operators/observable/b0;-><init>(Lio/reactivex/rxjava3/subjects/h;)V
    ...
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;->worker:Ljb/p;

    new-instance v3, Lio/reactivex/rxjava3/internal/operators/observable/d0;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lio/reactivex/rxjava3/internal/operators/observable/d0;-><init>(Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;Z)V
    ...
    invoke-virtual {v2, v3, v4, v5, v6}, Ljb/p;->b(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/b;

    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;->worker:Ljb/p;

    new-instance v8, Lio/reactivex/rxjava3/internal/operators/observable/d0;

    const/4 v2, 0x1

    invoke-direct {v8, p0, v2}, Lio/reactivex/rxjava3/internal/operators/observable/d0;-><init>(Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;Z)V
    ...
    invoke-virtual/range {v7 .. v13}, Ljb/p;->c(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/b;

    invoke-virtual {v1}, Lio/reactivex/rxjava3/internal/operators/observable/b0;->c()Z
...
.method public drain()V
    ...
    invoke-virtual {v7, v5}, Lio/reactivex/rxjava3/subjects/h;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v8, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;->worker:Ljb/p;

    new-instance v9, Lio/reactivex/rxjava3/internal/operators/observable/d0;

    invoke-direct {v9, p0, v7}, Lio/reactivex/rxjava3/internal/operators/observable/d0;-><init>(Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver;Z)V
