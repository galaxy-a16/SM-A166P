...
.method public constructor <init>(Ljb/m;JLjava/util/concurrent/TimeUnit;Ljb/q;I)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p5, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->scheduler:Ljb/q;
    ...
    new-instance p1, Lio/reactivex/rxjava3/internal/operators/observable/x;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, Lio/reactivex/rxjava3/internal/operators/observable/x;-><init>(Ljava/lang/Object;I)V
...
.method public createFirstWindow()V
    ...
    invoke-static {v0, v1}, Lio/reactivex/rxjava3/subjects/h;->c(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/subjects/h;

    move-result-object v0

    iput-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->window:Lio/reactivex/rxjava3/subjects/h;
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$AbstractWindowObserver;->downstream:Ljb/m;
    ...
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->scheduler:Ljb/q;
    ...
    invoke-virtual {v0, v2}, Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;->replace(Lio/reactivex/rxjava3/disposables/b;)Z
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->window:Lio/reactivex/rxjava3/subjects/h;
...
.method public drain()V
    ...
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->window:Lio/reactivex/rxjava3/subjects/h;
    ...
    iput-object v6, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->window:Lio/reactivex/rxjava3/subjects/h;
    ...
    invoke-static {v2, v5}, Lio/reactivex/rxjava3/subjects/h;->c(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/subjects/h;

    move-result-object v2

    iput-object v2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;->window:Lio/reactivex/rxjava3/subjects/h;

    new-instance v5, Lio/reactivex/rxjava3/internal/operators/observable/b0;

    invoke-direct {v5, v2}, Lio/reactivex/rxjava3/internal/operators/observable/b0;-><init>(Lio/reactivex/rxjava3/subjects/h;)V

    invoke-interface {v1, v5}, Ljb/m;->onNext(Ljava/lang/Object;)V

    invoke-virtual {v5}, Lio/reactivex/rxjava3/internal/operators/observable/b0;->c()Z
    ...
    invoke-virtual {v2, v7}, Lio/reactivex/rxjava3/subjects/h;->onNext(Ljava/lang/Object;)V
