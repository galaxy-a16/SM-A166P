...
# direct methods
.method public constructor <init>(Leb/n;JJI)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindow$WindowSkipObserver;->downstream:Leb/n;
...
.method public onComplete()V
    ...
    check-cast v1, Lio/reactivex/subjects/h;

    invoke-virtual {v1}, Lio/reactivex/subjects/h;->onComplete()V

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableWindow$WindowSkipObserver;->downstream:Leb/n;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, p1}, Lio/reactivex/subjects/h;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindow$WindowSkipObserver;->downstream:Leb/n;

    invoke-interface {v5, v6}, Leb/n;->onNext(Ljava/lang/Object;)V
    ...
    check-cast v10, Lio/reactivex/subjects/h;

    invoke-virtual {v10, p1}, Lio/reactivex/subjects/h;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lio/reactivex/subjects/h;->onComplete()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableWindow$WindowSkipObserver;->upstream:Lio/reactivex/disposables/b;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindow$WindowSkipObserver;->downstream:Leb/n;
