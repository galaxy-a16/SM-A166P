...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Lvc/d;->request(J)V
    ...
    invoke-static {p1, p2, p3}, Lh3/a;->b(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lvc/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lvc/d;)Z
    ...
    invoke-interface {p2, p0, p1}, Lvc/d;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lvc/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static reportMoreProduced(J)V
    ...
    invoke-static {v1, p0, p1}, Landroidx/activity/b;->k(Ljava/lang/String;J)Ljava/lang/String;
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lvc/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lvc/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lvc/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p2, p3}, Lvc/d;->request(J)V
...
.method public static validate(Lvc/d;Lvc/d;)Z
    .locals 1
