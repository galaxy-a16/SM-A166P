...
# direct methods
.method public constructor <init>(Lvc/c;Lgb/h;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lvc/c;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lgb/h;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lvc/d;
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lib/g;
...
.method public checkTerminated(ZZLvc/c;Lib/g;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p4}, Lib/g;->clear()V
    ...
    invoke-static {p1}, Lio/reactivex/internal/util/b;->b(Ljava/util/concurrent/atomic/AtomicReference;)Ljava/lang/Throwable;
...
.method public consumedOne(Z)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lvc/d;
...
.method public drain()V
    ...
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lvc/c;

    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lib/g;
    ...
    :try_start_0
    invoke-interface {v3}, Lib/g;->poll()Ljava/lang/Object;
    ...
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLvc/c;Lib/g;)Z
    ...
    :try_start_1
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lgb/h;

    invoke-interface {v6, v10}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lvc/d;
    ...
    invoke-static {v0, v4}, Lio/reactivex/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    invoke-interface {v3}, Lib/g;->clear()V
    ...
    invoke-virtual {v1, v15, v5, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLvc/c;Lib/g;)Z
    ...
    invoke-static {v15, v4}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-virtual {v1, v4, v5, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLvc/c;Lib/g;)Z
    ...
    invoke-static {v0, v3}, Lio/reactivex/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    :goto_5
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lvc/d;
    ...
    invoke-static {v3, v0}, Lio/reactivex/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    invoke-interface {v3}, Lib/g;->isEmpty()Z
    ...
    :goto_9
    invoke-virtual {v1, v4, v6, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLvc/c;Lib/g;)Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lib/g;
...
.method public onSubscribe(Lvc/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lvc/d;
    ...
    invoke-interface {v0, v1}, Lib/c;->requestFusion(I)I
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lib/g;

    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lvc/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lvc/c;
...
.method public poll()Ljava/lang/Object;
    ...
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lgb/h;

    invoke-interface {v2, v0}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v2, v3}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
