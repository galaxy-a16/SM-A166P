...
# instance fields
.field final boundarySubscriber:Lio/reactivex/rxjava3/internal/operators/flowable/r;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lvc/c;I)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->downstream:Lvc/c;
    ...
    new-instance p1, Lio/reactivex/rxjava3/internal/operators/flowable/r;

    invoke-direct {p1, p0}, Lio/reactivex/rxjava3/internal/operators/flowable/r;-><init>(Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;)V

    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->boundarySubscriber:Lio/reactivex/rxjava3/internal/operators/flowable/r;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/rxjava3/internal/queue/a;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->boundarySubscriber:Lio/reactivex/rxjava3/internal/operators/flowable/r;

    invoke-virtual {v0}, Lio/reactivex/rxjava3/subscribers/a;->dispose()V
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->downstream:Lvc/c;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/rxjava3/internal/queue/a;
    ...
    iput-object v8, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->window:Lio/reactivex/rxjava3/processors/g;

    return-void

    :cond_2
    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->window:Lio/reactivex/rxjava3/processors/g;
    ...
    invoke-virtual {v7, v1}, Lio/reactivex/rxjava3/processors/g;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v7}, Lio/reactivex/rxjava3/processors/g;->onComplete()V
    ...
    invoke-virtual {v7, v10}, Lio/reactivex/rxjava3/processors/g;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v7, p0}, Lio/reactivex/rxjava3/processors/g;->e(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/processors/g;

    move-result-object v7

    iput-object v7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->window:Lio/reactivex/rxjava3/processors/g;
    ...
    new-instance v8, Lio/reactivex/rxjava3/internal/operators/flowable/u;

    invoke-direct {v8, v7}, Lio/reactivex/rxjava3/internal/operators/flowable/u;-><init>(Lio/reactivex/rxjava3/processors/g;)V

    invoke-interface {v0, v8}, Lvc/c;->onNext(Ljava/lang/Object;)V

    invoke-virtual {v8}, Lio/reactivex/rxjava3/internal/operators/flowable/u;->d()Z
    ...
    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->boundarySubscriber:Lio/reactivex/rxjava3/internal/operators/flowable/r;

    invoke-virtual {v7}, Lio/reactivex/rxjava3/subscribers/a;->dispose()V
...
.method public innerNext()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowBoundary$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/rxjava3/internal/queue/a;
