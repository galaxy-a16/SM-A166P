...
.implements Lio/reactivex/rxjava3/internal/operators/observable/t;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Ljb/m;",
        "Lio/reactivex/rxjava3/disposables/b;",
        "Lio/reactivex/rxjava3/internal/operators/observable/t;"
    }
.end annotation
...
.field final itemTimeoutIndicator:Llb/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Llb/h;"
        }
...
# direct methods
.method public constructor <init>(Ljb/m;Llb/h;Ljb/l;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Ljb/m;

    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->itemTimeoutIndicator:Llb/h;
    ...
    iput-object p3, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:Ljb/l;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Ljb/m;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->itemTimeoutIndicator:Llb/h;
    ...
    invoke-direct {v0, v5, v6, p0}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutConsumer;-><init>(JLio/reactivex/rxjava3/internal/operators/observable/t;)V

    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->task:Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;

    invoke-virtual {p0, v0}, Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;->replace(Lio/reactivex/rxjava3/disposables/b;)Z
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Ljb/m;
...
.method public onTimeout(J)V
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:Ljb/l;

    const/4 p2, 0x0

    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:Ljb/l;

    new-instance p2, Lio/reactivex/rxjava3/internal/operators/observable/u;

    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:Ljb/m;

    invoke-direct {p2, v0, p0}, Lio/reactivex/rxjava3/internal/operators/observable/u;-><init>(Ljb/m;Ljava/util/concurrent/atomic/AtomicReference;)V

    invoke-interface {p1, p2}, Ljb/l;->subscribe(Ljb/m;)V
...
.method public onTimeoutError(JLjava/lang/Throwable;)V
    ...
    invoke-interface {p0, p3}, Ljb/m;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_0
    invoke-static {p3}, Lv4/b;->Q(Ljava/lang/Throwable;)V

    :goto_0
    return-void
.end method

.method public startFirstTimeout(Ljb/l;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, v2, p0}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableTimeout$TimeoutConsumer;-><init>(JLio/reactivex/rxjava3/internal/operators/observable/t;)V
