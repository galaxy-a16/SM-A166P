...
# direct methods
.method public constructor <init>(Lvc/c;Ljb/p;Lvc/b;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lvc/c;

    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->worker:Ljb/p;

    iput-object p3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lvc/b;
...
.method public cancel()V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->worker:Ljb/p;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lvc/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lvc/c;
...
.method public onSubscribe(Lvc/d;)V
    ...
    invoke-virtual {p0, v3, v4, p1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLvc/d;)V
...
.method public request(J)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLvc/d;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLvc/d;)V
...
.method public requestUpstream(JLvc/d;)V
    .locals 2
    ...
    invoke-direct {v0, p3, p1, p2, v1}, Lio/reactivex/internal/operators/flowable/s;-><init>(Lvc/d;JI)V

    invoke-virtual {p0, v0}, Ljb/p;->a(Ljava/lang/Runnable;)Lio/reactivex/rxjava3/disposables/b;

    goto :goto_1

    :cond_1
    :goto_0
    invoke-interface {p3, p1, p2}, Lvc/d;->request(J)V
...
.method public run()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lvc/b;

    const/4 v1, 0x0

    iput-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lvc/b;
