...
# direct methods
.method public constructor <init>(Lvc/c;Lgb/h;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lvc/c;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Lgb/h;
...
.method public checkTerminated(ZZLvc/c;Lio/reactivex/internal/queue/b;)Z
    ...
    invoke-static {p0}, Lio/reactivex/internal/util/b;->b(Ljava/util/concurrent/atomic/AtomicReference;)Ljava/lang/Throwable;

    move-result-object p0

    if-eqz p0, :cond_1

    sget-object p1, Lio/reactivex/internal/util/b;->a:Ljava/lang/Throwable;
...
.method public clear()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/internal/queue/b;
...
.method public drainAsync()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lvc/c;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLvc/c;Lio/reactivex/internal/queue/b;)Z
    ...
    :try_start_0
    iget-object v11, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Lgb/h;

    invoke-interface {v11, v10}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v10

    const-string v11, "The combiner returned a null value"

    invoke-static {v10, v11}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v2, v1}, Lio/reactivex/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLvc/c;Lio/reactivex/internal/queue/b;)Z
...
.method public innerError(ILjava/lang/Throwable;)V
    ...
    invoke-static {v0, p2}, Lio/reactivex/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Lgb/h;

    invoke-interface {p0, v1}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    const-string v1, "The combiner returned a null value"

    invoke-static {p0, v1}, Lfc/c;->h(Ljava/lang/Object;Ljava/lang/String;)V
