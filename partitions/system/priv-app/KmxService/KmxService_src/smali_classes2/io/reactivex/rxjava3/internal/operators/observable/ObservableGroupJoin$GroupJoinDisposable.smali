...
.implements Lio/reactivex/rxjava3/internal/operators/observable/m;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lio/reactivex/rxjava3/internal/operators/observable/m;"
    }
.end annotation
...
.method public constructor <init>(Ljb/m;Llb/h;Llb/h;Llb/c;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->downstream:Ljb/m;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->queue:Lio/reactivex/rxjava3/operators/g;
    ...
    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->leftEnd:Llb/h;

    iput-object p3, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->rightEnd:Llb/h;

    iput-object p4, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->resultSelector:Llb/c;
...
.method public cancelAll()V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->disposables:Lio/reactivex/rxjava3/disposables/a;
...
.method public dispose()V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->queue:Lio/reactivex/rxjava3/operators/g;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->queue:Lio/reactivex/rxjava3/operators/g;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->downstream:Ljb/m;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->errorAll(Ljb/m;)V
    ...
    check-cast v2, Lio/reactivex/rxjava3/subjects/h;
    ...
    new-instance v5, Lio/reactivex/rxjava3/subjects/h;

    sget v6, Ljb/d;->a:I

    const/4 v7, 0x0

    invoke-direct {v5, v6, v7}, Lio/reactivex/rxjava3/subjects/h;-><init>(ILjava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->leftEnd:Llb/h;
    ...
    invoke-direct {v8, p0, v2, v6}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/rxjava3/internal/operators/observable/m;ZI)V
    ...
    :cond_9
    :try_start_1
    iget-object v6, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->resultSelector:Llb/c;
    ...
    invoke-virtual {v5, v6}, Lio/reactivex/rxjava3/subjects/h;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->fail(Ljava/lang/Throwable;Ljb/m;Lio/reactivex/rxjava3/operators/g;)V
    ...
    :try_start_2
    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->rightEnd:Llb/h;
    ...
    invoke-direct {v8, p0, v5, v6}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/rxjava3/internal/operators/observable/m;ZI)V
    ...
    check-cast v6, Lio/reactivex/rxjava3/subjects/h;

    invoke-virtual {v6, v4}, Lio/reactivex/rxjava3/subjects/h;->onNext(Ljava/lang/Object;)V
    ...
    check-cast v5, Lio/reactivex/rxjava3/subjects/h;
...
.method public errorAll(Ljb/m;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, v0}, Lio/reactivex/rxjava3/subjects/h;->onError(Ljava/lang/Throwable;)V
...
.method public fail(Ljava/lang/Throwable;Ljb/m;Lio/reactivex/rxjava3/operators/g;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p3}, Lio/reactivex/rxjava3/operators/g;->clear()V

    invoke-virtual {p0}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->cancelAll()V

    invoke-virtual {p0, p2}, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->errorAll(Ljb/m;)V
