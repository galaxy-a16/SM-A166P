...
.method public constructor <init>(Lvc/c;Llb/h;IIZ)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lvc/c;

    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Llb/h;
    ...
    invoke-direct {p1, p4}, Lio/reactivex/rxjava3/operators/g;-><init>(I)V

    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/rxjava3/operators/g;
...
.method public checkTerminated(ZZLvc/c;Lio/reactivex/rxjava3/operators/g;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-virtual {p4}, Lio/reactivex/rxjava3/operators/g;->clear()V
    ...
    invoke-virtual {p0, p3}, Lio/reactivex/rxjava3/internal/util/AtomicThrowable;->tryTerminateConsumer(Lvc/c;)V
...
.method public clear()V
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/rxjava3/operators/g;
...
.method public drainAsync()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lvc/c;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/rxjava3/operators/g;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLvc/c;Lio/reactivex/rxjava3/operators/g;)Z
    ...
    :try_start_0
    iget-object v11, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Llb/h;

    invoke-interface {v11, v10}, Llb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v10}, Lvc/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lio/reactivex/rxjava3/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLvc/c;Lio/reactivex/rxjava3/operators/g;)Z
...
.method public drainOutput()V
    ...
    invoke-interface {v0, v3}, Lvc/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v5}, Lvc/c;->onNext(Ljava/lang/Object;)V
...
.method public innerError(ILjava/lang/Throwable;)V
    ...
    invoke-static {v0, p2}, Lio/reactivex/rxjava3/internal/util/b;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
...
.method public innerValue(ILjava/lang/Object;)V
    ...
    iget-object p2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/rxjava3/operators/g;
    ...
    invoke-virtual {p2, v1, v0}, Lio/reactivex/rxjava3/operators/g;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/rxjava3/operators/g;
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Llb/h;

    invoke-interface {p0, v1}, Llb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
