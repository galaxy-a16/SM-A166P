...
# direct methods
.method public constructor <init>(Leb/n;Lgb/h;IILio/reactivex/internal/util/ErrorMode;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:Leb/n;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->mapper:Lgb/h;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->queue:Lib/g;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:Leb/n;
    ...
    :cond_4
    iget-object v8, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->mapper:Lgb/h;

    invoke-interface {v8, v7}, Lgb/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v6}, Lio/reactivex/internal/observers/InnerQueuedObserver;->queue()Lib/g;
    ...
    :cond_f
    :try_start_1
    invoke-interface {v8}, Lib/g;->poll()Ljava/lang/Object;
    ...
    :cond_12
    invoke-interface {v2, v10}, Leb/n;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v6}, Lv4/b;->Y(Ljava/lang/Throwable;)V
...
.method public innerNext(Lio/reactivex/internal/observers/InnerQueuedObserver;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lio/reactivex/internal/observers/InnerQueuedObserver;->queue()Lib/g;

    move-result-object p1

    invoke-interface {p1, p2}, Lib/g;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->queue:Lib/g;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:Leb/n;
