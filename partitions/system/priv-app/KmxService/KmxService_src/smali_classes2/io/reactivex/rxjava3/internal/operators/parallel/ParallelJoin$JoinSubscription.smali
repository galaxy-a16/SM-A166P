...
# direct methods
.method public constructor <init>(Lvc/c;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;-><init>(Lvc/c;II)V
...
.method public drainLoop()V
    ...
    iget-object v3, v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lvc/c;
    ...
    invoke-interface {v3, v12}, Lvc/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v4, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lio/reactivex/rxjava3/operators/e;

    if-eqz v13, :cond_6

    invoke-interface {v13}, Lio/reactivex/rxjava3/operators/f;->poll()Ljava/lang/Object;

    move-result-object v13

    if-eqz v13, :cond_6

    invoke-interface {v3, v13}, Lvc/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v3, v4}, Lvc/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v7, v7, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lio/reactivex/rxjava3/operators/e;
    ...
    invoke-static {v4, v10, v11}, Lh3/a;->H(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    :cond_0
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->errors:Lio/reactivex/rxjava3/internal/util/AtomicThrowable;
...
.method public onNext(Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lvc/c;
    ...
    :cond_1
    invoke-virtual {p1}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->getQueue()Lio/reactivex/rxjava3/operators/e;
    ...
    iget-object p0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lvc/c;
