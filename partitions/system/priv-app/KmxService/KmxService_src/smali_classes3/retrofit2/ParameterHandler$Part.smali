...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILokhttp3/s;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lretrofit2/ParameterHandler$Part;->headers:Lokhttp3/s;
...
.method public apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lretrofit2/ParameterHandler$Part;->headers:Lokhttp3/s;

    invoke-virtual {p1, p0, v0}, Lretrofit2/RequestBuilder;->addPart(Lokhttp3/s;Lokhttp3/i0;)V
