...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lokhttp3/u;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lokhttp3/u;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lokhttp3/s;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lokhttp3/s;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lokhttp3/w;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lokhttp3/w;
...
# virtual methods
.method public create([Ljava/lang/Object;)Lokhttp3/e0;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lokhttp3/u;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lokhttp3/s;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lokhttp3/w;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lokhttp3/u;Ljava/lang/String;Lokhttp3/s;Lokhttp3/w;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lokhttp3/d0;
    ...
    invoke-virtual {p1, p0, v0}, Lokhttp3/d0;->d(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-static {p1, v1, v2}, Landroidx/activity/b;->s(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, v0, v1}, Lcom/google/protobuf/n;->i(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
