...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v3, v5}, Lkotlin/jvm/internal/m;->n(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v3, v2, v5}, Lv4/b;->F(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v3, v2, v5}, Lv4/b;->H(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v8, p2, v0, v1}, Ll4/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Ln2/h;
    ...
    invoke-direct {p2, p0, v0}, Lz3/c;-><init>(Lcom/google/android/material/button/MaterialButton;Ll4/k;)V

    iput-object p2, p0, Lcom/google/android/material/button/MaterialButton;->d:Lz3/c;

    invoke-virtual {v2, v5, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v0

    iput v0, p2, Lz3/c;->c:I
    ...
    iput v0, p2, Lz3/c;->g:I

    iget-object v1, p2, Lz3/c;->b:Ll4/k;

    int-to-float v0, v0

    invoke-virtual {v1, v0}, Ll4/k;->e(F)Ll4/k;

    move-result-object v0

    invoke-virtual {p2, v0}, Lz3/c;->c(Ll4/k;)V

    iput-boolean v5, p2, Lz3/c;->p:Z
    ...
    invoke-static {v0, v1}, Lkotlin/jvm/internal/m;->n(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, p2, Lz3/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v0, v2, v1}, Lv4/b;->F(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, p2, Lz3/c;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p2, Lz3/c;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p2, Lz3/c;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v5, p2, Lz3/c;->o:Z

    iget-object v6, p2, Lz3/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, p2, Lz3/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_1
    invoke-virtual {p2}, Lz3/c;->e()V

    :goto_0
    iget v6, p2, Lz3/c;->c:I

    add-int/2addr v0, v6

    iget v6, p2, Lz3/c;->e:I

    add-int/2addr v1, v6

    iget v6, p2, Lz3/c;->d:I

    add-int/2addr v3, v6

    iget p2, p2, Lz3/c;->f:I

    add-int/2addr v4, p2

    invoke-static {p0, v0, v1, v3, v4}, Landroidx/core/view/j0;->k(Landroid/view/View;IIII)V
...
.method public final a()Z
    ...
    iget-object p0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lz3/c;

    if-eqz p0, :cond_0

    iget-boolean p0, p0, Lz3/c;->o:Z
...
.method public final b()V
    ...
    invoke-static {p0, v0, v4, v4, v4}, Le0/q;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v4, v4, v0, v4}, Le0/q;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v4, v0, v4, v4}, Le0/q;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public final c(Z)V
    ...
    :cond_4
    invoke-static {p0}, Le0/q;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lz3/c;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Ll4/k;
    ...
    iget-object p0, p0, Lz3/c;->b:Ll4/k;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lz3/c;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lz3/c;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, Lz3/c;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lz3/c;

    invoke-virtual {v1, v0}, Lz3/c;->b(Z)Ll4/h;
...
.method public final onCreateDrawableState(I)[I
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lz3/c;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lz3/c;->q:Z
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {p0, p1}, Ll4/h;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, v1, Lz3/c;->o:Z

    iget-object v0, v1, Lz3/c;->j:Landroid/content/res/ColorStateList;

    iget-object v2, v1, Lz3/c;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    iget-object v0, v1, Lz3/c;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setChecked(Z)V
    ...
    iget-object v2, p0, Lcom/google/android/material/button/MaterialButton;->d:Lz3/c;

    if-eqz v2, :cond_0

    iget-boolean v2, v2, Lz3/c;->q:Z
    ...
    iget-boolean v2, p0, Lcom/google/android/material/button/MaterialButton;->p:Z
    ...
    :cond_3
    iput-boolean v0, p0, Lcom/google/android/material/button/MaterialButton;->q:Z
    ...
    iput-boolean v1, p0, Lcom/google/android/material/button/MaterialButton;->q:Z
...
.method public setCornerRadius(I)V
    ...
    iget-object v0, p0, Lz3/c;->b:Ll4/k;
    ...
    invoke-virtual {p0, p1}, Lz3/c;->c(Ll4/k;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lz3/c;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lz3/c;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lz3/a;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->f:Lz3/a;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->f:Lz3/a;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lz3/c;->l:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lz3/c;->l:Landroid/content/res/ColorStateList;
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lz3/c;->k:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lz3/c;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lz3/c;->j:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lz3/c;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lz3/c;->b(Z)Ll4/h;
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v0, p0, Lz3/c;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lz3/c;->i:Landroid/graphics/PorterDuff$Mode;
