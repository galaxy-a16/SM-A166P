.class public Lcom/samsung/android/kmxservice/trustchain/client/data/request/AuthTokenRequest;
.super Lcom/samsung/android/kmxservice/trustchain/client/data/Request;
.source "SourceFile"


# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/kmxservice/common/samsungaccount/SamsungAccountToken;)V
    .locals 6

    invoke-direct {p0}, Lcom/samsung/android/kmxservice/trustchain/client/data/Request;-><init>()V

    invoke-direct {p0, p1}, Lcom/samsung/android/kmxservice/trustchain/client/data/request/AuthTokenRequest;->setUrl(Ljava/lang/String;)V

    invoke-virtual {p7}, Lcom/samsung/android/kmxservice/common/samsungaccount/SamsungAccountToken;->getSaToken()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/kmxservice/trustchain/client/data/request/AuthTokenRequest;->setHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/samsung/android/kmxservice/trustchain/client/data/request/AuthTokenRequest;->setBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/kmxservice/common/samsungaccount/SamsungAccountToken;)V

    return-void
.end method

.method private setBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/kmxservice/common/samsungaccount/SamsungAccountToken;)V
    .locals 2
    ...
    invoke-virtual {p5}, Lcom/samsung/android/kmxservice/common/samsungaccount/SamsungAccountToken;->getMcc()Ljava/lang/String;

    move-result-object p2

    const-string p3, "accountMcc"
    ...
    invoke-virtual {p5}, Lcom/samsung/android/kmxservice/common/samsungaccount/SamsungAccountToken;->getRegionMcc()Ljava/lang/String;
...
.method private setHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/kmxservice/trustchain/client/data/Request;->header:Lcom/samsung/android/kmxservice/trustchain/client/data/Request$RequestHeaders;

    const-string v1, "Bearer "

    const-string v2, "Authorization"

    invoke-static {v1, p1, v0, v2}, Lorg/spongycastle/jcajce/provider/digest/a;->n(Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/kmxservice/trustchain/client/data/Request$RequestHeaders;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/kmxservice/trustchain/client/data/Request$RequestHeaders;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
