...
.method public static complete(Leb/b;)V
    .locals 1

    .line 1
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Leb/b;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static complete(Leb/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Leb/h;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static complete(Leb/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Leb/n;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static error(Ljava/lang/Throwable;Leb/b;)V
    .locals 1

    .line 1
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p1, v0}, Leb/b;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static error(Ljava/lang/Throwable;Leb/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Leb/h;->onSubscribe(Lio/reactivex/disposables/b;)V

    invoke-interface {p1, p0}, Leb/h;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Leb/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p0}, Leb/n;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Leb/u;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Leb/u;->onSubscribe(Lio/reactivex/disposables/b;)V
