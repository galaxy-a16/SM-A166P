...
.method private pushLater(Lio/netty/util/Recycler$DefaultHandle;Ljava/lang/Thread;)V
    ...
    :cond_3
    sget-object p0, Lio/netty/util/Recycler$WeakOrderQueue;->DUMMY:Lio/netty/util/Recycler$WeakOrderQueue;
...
.method public pop()Lio/netty/util/Recycler$DefaultHandle;
    ...
    iget p0, v3, Lio/netty/util/Recycler$DefaultHandle;->lastRecycledId:I

    iget v0, v3, Lio/netty/util/Recycler$DefaultHandle;->recycleId:I

    if-ne p0, v0, :cond_2

    const/4 p0, 0x0

    iput p0, v3, Lio/netty/util/Recycler$DefaultHandle;->recycleId:I

    iput p0, v3, Lio/netty/util/Recycler$DefaultHandle;->lastRecycledId:I
