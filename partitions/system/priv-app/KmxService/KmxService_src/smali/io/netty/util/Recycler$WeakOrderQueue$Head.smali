...
.method private reclaimSpace(I)V
    ...
    iget-object p0, p0, Lio/netty/util/Recycler$WeakOrderQueue$Head;->availableSharedCapacity:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public newLink()Lio/netty/util/Recycler$WeakOrderQueue$Link;
    ...
    invoke-static {p0}, Lio/netty/util/Recycler$WeakOrderQueue$Head;->reserveSpaceForLink(Ljava/util/concurrent/atomic/AtomicInteger;)Z

    move-result p0

    if-eqz p0, :cond_0

    new-instance p0, Lio/netty/util/Recycler$WeakOrderQueue$Link;
