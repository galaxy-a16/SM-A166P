...
.method public add(Lio/netty/util/Recycler$DefaultHandle;)V
    ...
    :cond_2
    iget-object p0, v0, Lio/netty/util/Recycler$WeakOrderQueue$Link;->elements:[Lio/netty/util/Recycler$DefaultHandle;

    aput-object p1, p0, v1

    const/4 p0, 0x0

    iput-object p0, p1, Lio/netty/util/Recycler$DefaultHandle;->stack:Lio/netty/util/Recycler$Stack;
...
.method public transfer(Lio/netty/util/Recycler$Stack;)Z
    ...
    iget-object p0, p0, Lio/netty/util/Recycler$WeakOrderQueue;->head:Lio/netty/util/Recycler$WeakOrderQueue$Head;

    invoke-virtual {p0, v2}, Lio/netty/util/Recycler$WeakOrderQueue$Head;->relink(Lio/netty/util/Recycler$WeakOrderQueue$Link;)V

    :cond_9
    iput v3, v0, Lio/netty/util/Recycler$WeakOrderQueue$Link;->readIndex:I

    iget p0, p1, Lio/netty/util/Recycler$Stack;->size:I
