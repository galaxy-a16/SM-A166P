...
.method private validate(Lio/netty/channel/ChannelInboundHandler;Lio/netty/channel/ChannelOutboundHandler;)V
    ...
    const-string p1, "outboundHandler must not implement ChannelInboundHandler to get combined."
    ...
    const-string p1, "inboundHandler must not implement ChannelOutboundHandler to get combined."
    ...
    const-string p1, "init() can not be invoked if CombinedChannelDuplexHandler was constructed with non-default constructor."
...
.method public handlerAdded(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    const-string p1, "init() must be invoked before being added to a ChannelPipeline if CombinedChannelDuplexHandler was constructed with the default constructor."
