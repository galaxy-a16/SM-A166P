...
.method public static J(Ld1/w;Ld1/w;)Ld1/f0;
    .locals 8
    ...
    iput-boolean v1, v0, Ld1/f0;->a:Z

    iput-boolean v1, v0, Ld1/f0;->b:Z
    ...
    iget-object v6, p0, Ld1/w;->a:Ljava/util/HashMap;
    ...
    iput-object v6, v0, Ld1/f0;->e:Landroid/view/ViewGroup;

    goto :goto_0

    :cond_0
    iput v4, v0, Ld1/f0;->c:I

    iput-object v3, v0, Ld1/f0;->e:Landroid/view/ViewGroup;

    :goto_0
    if-eqz p1, :cond_1

    iget-object v6, p1, Ld1/w;->a:Ljava/util/HashMap;
    ...
    iput-object v2, v0, Ld1/f0;->f:Landroid/view/ViewGroup;

    goto :goto_1

    :cond_1
    iput v4, v0, Ld1/f0;->d:I

    iput-object v3, v0, Ld1/f0;->f:Landroid/view/ViewGroup;
    ...
    iget p0, v0, Ld1/f0;->c:I

    iget p1, v0, Ld1/f0;->d:I

    if-ne p0, p1, :cond_2

    iget-object v3, v0, Ld1/f0;->e:Landroid/view/ViewGroup;

    iget-object v4, v0, Ld1/f0;->f:Landroid/view/ViewGroup;
    ...
    :cond_4
    iget-object p0, v0, Ld1/f0;->f:Landroid/view/ViewGroup;
    ...
    :cond_5
    iget-object p0, v0, Ld1/f0;->e:Landroid/view/ViewGroup;
    ...
    iget p0, v0, Ld1/f0;->d:I

    if-nez p0, :cond_7

    :goto_2
    iput-boolean v2, v0, Ld1/f0;->b:Z
...
.method public final I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    sget-object p2, Ld1/x;->a:Landroidx/appcompat/widget/c4;
    ...
    invoke-direct {p3, p1}, Landroidx/recyclerview/widget/o;-><init>(Landroid/view/View;)V

    invoke-virtual {p2, p3}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    new-instance p3, Ld1/g;

    invoke-direct {p3, v1, p0, p1}, Ld1/g;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {p0, p3}, Ld1/q;->a(Ld1/p;)V
...
.method public final d(Ld1/w;)V
    ...
    invoke-virtual {p0, p1}, Ld1/h;->H(Ld1/w;)V
...
.method public final g(Ld1/w;)V
    ...
    iget-object p1, p1, Ld1/w;->b:Landroid/view/View;
...
.method public final k(Landroid/view/ViewGroup;Ld1/w;Ld1/w;)Landroid/animation/Animator;
    ...
    invoke-static/range {p2 .. p3}, Ld1/h;->J(Ld1/w;Ld1/w;)Ld1/f0;

    move-result-object v4

    iget-boolean v5, v4, Ld1/f0;->a:Z

    if-eqz v5, :cond_1e

    iget-object v5, v4, Ld1/f0;->e:Landroid/view/ViewGroup;

    if-nez v5, :cond_0

    iget-object v5, v4, Ld1/f0;->f:Landroid/view/ViewGroup;

    if-eqz v5, :cond_1e

    :cond_0
    iget-boolean v5, v4, Ld1/f0;->b:Z
    ...
    :cond_1
    iget-object v1, v3, Ld1/w;->b:Landroid/view/View;
    ...
    invoke-virtual {v0, v3, v11}, Ld1/q;->n(Landroid/view/View;Z)Ld1/w;

    move-result-object v4

    invoke-virtual {v0, v3, v11}, Ld1/q;->q(Landroid/view/View;Z)Ld1/w;

    move-result-object v3

    invoke-static {v4, v3}, Ld1/h;->J(Ld1/w;Ld1/w;)Ld1/f0;

    move-result-object v3

    iget-boolean v3, v3, Ld1/f0;->a:Z
    ...
    iget-object v2, v2, Ld1/w;->a:Ljava/util/HashMap;
    ...
    :goto_1
    invoke-virtual {v0, v1, v9, v10}, Ld1/h;->I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    iget-object v3, v3, Ld1/w;->b:Landroid/view/View;
    ...
    :goto_3
    iget-object v5, v2, Ld1/w;->b:Landroid/view/View;
    ...
    invoke-virtual {v0, v15, v7}, Ld1/q;->q(Landroid/view/View;Z)Ld1/w;

    move-result-object v6

    invoke-virtual {v0, v15, v7}, Ld1/q;->n(Landroid/view/View;Z)Ld1/w;

    move-result-object v13

    invoke-static {v6, v13}, Ld1/h;->J(Ld1/w;Ld1/w;)Ld1/f0;

    move-result-object v6

    iget-boolean v6, v6, Ld1/f0;->a:Z
    ...
    sget-object v13, Ld1/x;->a:Landroidx/appcompat/widget/c4;
    ...
    :goto_d
    iget-object v0, v0, Ld1/w;->a:Ljava/util/HashMap;
    ...
    invoke-direct {v3, v1}, Lp5/c;-><init>(Landroid/view/ViewGroup;)V

    iget-object v3, v3, Lp5/c;->b:Ljava/lang/Object;
    ...
    :cond_18
    sget-object v3, Ld1/x;->a:Landroidx/appcompat/widget/c4;
    ...
    :goto_e
    invoke-virtual {v6, v14, v10, v0}, Ld1/h;->I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v2, v1}, Lp5/c;-><init>(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v2, v6, v1, v14, v5}, Ld1/d0;-><init>(Ld1/h;Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)V
    ...
    sget-object v5, Ld1/x;->a:Landroidx/appcompat/widget/c4;
    ...
    invoke-virtual {v6, v3, v10, v0}, Ld1/h;->I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v2, v3, v1}, Ld1/e0;-><init>(Landroid/view/View;I)V
    ...
    :goto_10
    invoke-virtual {v6, v2}, Ld1/q;->a(Ld1/p;)V
...
.method public final bridge synthetic p()[Ljava/lang/String;
    ...
    sget-object p0, Ld1/h;->B:[Ljava/lang/String;

    return-object p0
.end method

.method public final r(Ld1/w;Ld1/w;)Z
    .locals 2
    ...
    iget-object p0, p2, Ld1/w;->a:Ljava/util/HashMap;
    ...
    iget-object v1, p1, Ld1/w;->a:Ljava/util/HashMap;
    ...
    :cond_1
    invoke-static {p1, p2}, Ld1/h;->J(Ld1/w;Ld1/w;)Ld1/f0;

    move-result-object p0

    iget-boolean p1, p0, Ld1/f0;->a:Z

    if-eqz p1, :cond_3

    iget p1, p0, Ld1/f0;->c:I

    if-eqz p1, :cond_2

    iget p0, p0, Ld1/f0;->d:I
