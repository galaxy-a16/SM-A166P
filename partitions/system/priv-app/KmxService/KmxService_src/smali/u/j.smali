...
.field private mLocalPathStrategy:Lu/h;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lu/j;->COLUMNS:[Ljava/lang/String;
    ...
    sput-object v0, Lu/j;->DEVICE_ROOT:Ljava/io/File;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lu/j;->sCache:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lu/j;->mResourceId:I

    return-void
.end method

.method public static b(ILandroid/content/Context;Ljava/lang/String;)Lu/h;
    .locals 2

    sget-object v0, Lu/j;->sCache:Ljava/util/HashMap;
    ...
    :try_start_1
    invoke-static {p0, p1, p2}, Lu/j;->c(ILandroid/content/Context;Ljava/lang/String;)Lu/i;
...
.method public static c(ILandroid/content/Context;Ljava/lang/String;)Lu/i;
    .locals 6

    new-instance v0, Lu/i;

    invoke-direct {v0, p2}, Lu/i;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v1, p0}, Lu/j;->getFileProviderPathsMetaData(Landroid/content/Context;Ljava/lang/String;Landroid/content/pm/ProviderInfo;I)Landroid/content/res/XmlResourceParser;
    ...
    sget-object v1, Lu/j;->DEVICE_ROOT:Ljava/io/File;
    ...
    invoke-static {p1, v1}, Lu/b;->b(Landroid/content/Context;Ljava/lang/String;)[Ljava/io/File;
    ...
    invoke-static {p1}, Lu/b;->a(Landroid/content/Context;)[Ljava/io/File;
    ...
    invoke-static {p1}, Lu/g;->a(Landroid/content/Context;)[Ljava/io/File;
    ...
    iget-object v1, v0, Lu/i;->b:Ljava/util/HashMap;
...
.method public static getUriForFile(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    ...
    invoke-static {v0, p0, p1}, Lu/j;->b(ILandroid/content/Context;Ljava/lang/String;)Lu/h;
    ...
    iget-object p2, p0, Lu/i;->b:Ljava/util/HashMap;
...
.method public static getUriForFile(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 8
    invoke-static {p0, p1, p2}, Lu/j;->getUriForFile(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
...
.method public final a()Lu/h;
    ...
    :try_start_0
    iget-object v0, p0, Lu/j;->mLocalPathStrategy:Lu/h;
    ...
    iget-object v1, p0, Lu/j;->mAuthority:Ljava/lang/String;

    iget v2, p0, Lu/j;->mResourceId:I

    invoke-static {v2, v0, v1}, Lu/j;->b(ILandroid/content/Context;Ljava/lang/String;)Lu/h;

    move-result-object v0

    iput-object v0, p0, Lu/j;->mLocalPathStrategy:Lu/h;
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    iput-object p1, p0, Lu/j;->mAuthority:Ljava/lang/String;

    sget-object p1, Lu/j;->sCache:Ljava/util/HashMap;

    monitor-enter p1

    :try_start_0
    iget-object p0, p0, Lu/j;->mAuthority:Ljava/lang/String;
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {p0}, Lu/j;->a()Lu/h;

    move-result-object p0

    check-cast p0, Lu/i;

    invoke-virtual {p0, p1}, Lu/i;->a(Landroid/net/Uri;)Ljava/io/File;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    sget-object p2, Lu/j;->COLUMNS:[Ljava/lang/String;
