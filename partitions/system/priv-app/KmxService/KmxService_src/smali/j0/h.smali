...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Lj0/h;->j:Landroid/widget/TextView;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lj0/h;->l:Z

    new-instance v0, Lj0/f;

    invoke-direct {v0, p1}, Lj0/f;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Lj0/h;->k:Lj0/f;
...
.method public final B(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
    ...
    invoke-direct {p0, p1}, Lj0/k;-><init>(Landroid/text/method/TransformationMethod;)V
    ...
    iget-object p1, p1, Lj0/k;->a:Landroid/text/method/TransformationMethod;
...
.method public final j([Landroid/text/InputFilter;)[Landroid/text/InputFilter;
    ...
    :goto_3
    iget-object v4, p0, Lj0/h;->k:Lj0/f;
...
.method public final x(Z)V
    ...
    iget-object p1, p0, Lj0/h;->j:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/widget/TextView;->getTransformationMethod()Landroid/text/method/TransformationMethod;

    move-result-object v0

    invoke-virtual {p0, v0}, Lj0/h;->B(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final y(Z)V
    ...
    invoke-virtual {p0, v0}, Lj0/h;->j([Landroid/text/InputFilter;)[Landroid/text/InputFilter;
