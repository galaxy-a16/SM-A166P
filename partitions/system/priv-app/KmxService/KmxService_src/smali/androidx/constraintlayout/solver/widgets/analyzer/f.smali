...
# instance fields
.field public a:Landroidx/constraintlayout/solver/widgets/analyzer/r;

.field public b:Z

.field public c:Z

.field public final d:Landroidx/constraintlayout/solver/widgets/analyzer/r;
...
.method public constructor <init>(Landroidx/constraintlayout/solver/widgets/analyzer/r;)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->a:Landroidx/constraintlayout/solver/widgets/analyzer/r;
    ...
    iput-object v2, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->e:Landroidx/constraintlayout/solver/widgets/analyzer/DependencyNode$Type;
    ...
    iput-object v0, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->k:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->l:Ljava/util/ArrayList;

    iput-object p1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->d:Landroidx/constraintlayout/solver/widgets/analyzer/r;
...
.method public final a(Landroidx/constraintlayout/solver/widgets/analyzer/d;)V
    ...
    iget-object p1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->l:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->a:Landroidx/constraintlayout/solver/widgets/analyzer/r;
    ...
    :cond_2
    iget-boolean v1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->b:Z

    if-eqz v1, :cond_3

    iget-object p1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->d:Landroidx/constraintlayout/solver/widgets/analyzer/r;
    ...
    iget-boolean p1, v1, Landroidx/constraintlayout/solver/widgets/analyzer/f;->j:Z
    ...
    iget v0, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->h:I

    iget p1, p1, Landroidx/constraintlayout/solver/widgets/analyzer/f;->g:I

    mul-int/2addr v0, p1

    iput v0, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->f:I
    ...
    :cond_7
    :goto_1
    iget p1, v1, Landroidx/constraintlayout/solver/widgets/analyzer/f;->g:I
    ...
    :cond_8
    iget-object p1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->a:Landroidx/constraintlayout/solver/widgets/analyzer/r;
...
.method public final b(Landroidx/constraintlayout/solver/widgets/analyzer/d;)V
    .locals 1
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->d:Landroidx/constraintlayout/solver/widgets/analyzer/r;
    ...
    iget-object v1, p0, Landroidx/constraintlayout/solver/widgets/analyzer/f;->e:Landroidx/constraintlayout/solver/widgets/analyzer/DependencyNode$Type;
