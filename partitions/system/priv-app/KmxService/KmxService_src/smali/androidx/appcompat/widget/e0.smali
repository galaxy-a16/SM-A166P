...
.method public final a()V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/e0;->b:Landroidx/appcompat/widget/i4;
...
.method public final b(Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Lb/a;->f:[I

    invoke-static {v0, p1, v2, p2}, Landroidx/appcompat/widget/b3;->m(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/b3;
    ...
    iget-object v4, v7, Landroidx/appcompat/widget/b3;->b:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v7, v0, p2}, Landroidx/appcompat/widget/b3;->i(II)I
    ...
    invoke-virtual {v7, p1}, Landroidx/appcompat/widget/b3;->l(I)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {v7, p1}, Landroidx/appcompat/widget/b3;->b(I)Landroid/content/res/ColorStateList;

    move-result-object p1

    invoke-static {p0, p1}, Le0/f;->c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v7, p1, p2}, Landroidx/appcompat/widget/b3;->h(II)I
    ...
    invoke-static {p0, p1}, Le0/f;->d(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_3
    invoke-virtual {v7}, Landroidx/appcompat/widget/b3;->n()V
