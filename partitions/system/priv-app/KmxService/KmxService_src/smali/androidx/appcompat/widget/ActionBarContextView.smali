...
.method public final f(Lg/c;)V
    ...
    invoke-direct {v3, p0, p1}, Landroidx/appcompat/widget/d;-><init>(Landroidx/appcompat/widget/ActionBarContextView;Lg/c;)V

    invoke-virtual {v1, v3}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lg/c;->c()Lh/n;

    move-result-object p1

    iget-object v1, p0, Landroidx/appcompat/widget/b;->d:Landroidx/appcompat/widget/p;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Landroidx/appcompat/widget/p;->m()Z

    iget-object v1, v1, Landroidx/appcompat/widget/p;->x:Landroidx/appcompat/widget/i;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Lh/z;->b()Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object v1, v1, Lh/z;->j:Lh/g0;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/b;->d:Landroidx/appcompat/widget/p;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/b;->d:Landroidx/appcompat/widget/p;

    iget-object v4, p0, Landroidx/appcompat/widget/b;->b:Landroid/content/Context;

    invoke-virtual {p1, v3, v4}, Lh/n;->b(Lh/b0;Landroid/content/Context;)V

    iget-object p1, p0, Landroidx/appcompat/widget/b;->d:Landroidx/appcompat/widget/p;

    iget-object v3, p1, Lh/d;->h:Lh/d0;

    if-nez v3, :cond_3

    iget-object v4, p1, Lh/d;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v2, p1, Lh/d;->h:Lh/d0;

    iget-object v4, p1, Lh/d;->c:Lh/n;

    invoke-interface {v2, v4}, Lh/d0;->a(Lh/n;)V

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/p;->e(Z)V

    :cond_3
    iget-object v0, p1, Lh/d;->h:Lh/d0;
    ...
    invoke-static {v0, p1}, Landroidx/core/view/i0;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/b;->f:Landroidx/core/view/i1;
...
.method public final h()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/b;->d:Landroidx/appcompat/widget/p;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/b;->d:Landroidx/appcompat/widget/p;
...
.method public final onLayout(ZIIII)V
    ...
    :goto_5
    iget-object p0, p0, Landroidx/appcompat/widget/b;->c:Landroidx/appcompat/widget/ActionMenuView;
...
.method public final onMeasure(II)V
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->p:Landroid/widget/TextView;

    const/4 v9, 0x1

    if-eqz v8, :cond_4

    sget-object v8, Lb/a;->A:[I

    iget v10, p0, Landroidx/appcompat/widget/ActionBarContextView;->t:I
    ...
    :goto_3
    iget-object v12, p0, Landroidx/appcompat/widget/ActionBarContextView;->p:Landroid/widget/TextView;
    ...
    :goto_4
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContextView;->q:Landroid/widget/TextView;
