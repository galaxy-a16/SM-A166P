...
.method public constructor <init>(Landroidx/viewpager2/widget/ViewPager2;)V
    ...
    iput-object p1, p0, Lh1/k;->e:Landroidx/viewpager2/widget/ViewPager2;

    invoke-direct {p0, p1}, Lb0/h;-><init>(Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Lh1/k;->b:Ld/s0;
    ...
    iput-object p1, p0, Lh1/k;->c:Lp5/c;
...
# virtual methods
.method public final l(Landroidx/recyclerview/widget/j0;)V
    .locals 0
    ...
    iget-object p0, p0, Lh1/k;->d:Lh1/e;
...
.method public final m(Landroidx/recyclerview/widget/j0;)V
    .locals 0
...
.method public final n(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lh1/k;->d:Lh1/e;
...
.method public final o(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/j0;->getItemCount()I
    ...
    iget-boolean v2, p0, Landroidx/viewpager2/widget/ViewPager2;->t:Z
...
.method public final p(ILandroid/os/Bundle;)V
    ...
    :goto_2
    iget-boolean p2, p0, Landroidx/viewpager2/widget/ViewPager2;->t:Z
...
.method public final r()V
    ...
    iget-object v0, p0, Lh1/k;->e:Landroidx/viewpager2/widget/ViewPager2;
    ...
    invoke-static {v0, v2}, Landroidx/core/view/x0;->d(Landroid/view/View;I)V

    const v3, 0x1020049

    invoke-static {v0, v3}, Landroidx/core/view/x0;->e(Landroid/view/View;I)V
    ...
    invoke-static {v0, v5}, Landroidx/core/view/x0;->e(Landroid/view/View;I)V
    ...
    :cond_1
    iget-boolean v7, v0, Landroidx/viewpager2/widget/ViewPager2;->t:Z
    ...
    iget-object v8, p0, Lh1/k;->c:Lp5/c;

    iget-object p0, p0, Lh1/k;->b:Ld/s0;

    if-nez v7, :cond_7

    iget-object v4, v0, Landroidx/viewpager2/widget/ViewPager2;->f:Lh1/i;

    invoke-virtual {v4}, Landroidx/recyclerview/widget/u0;->B()I
    ...
    :cond_5
    iget v2, v0, Landroidx/viewpager2/widget/ViewPager2;->c:I
    ...
    invoke-static {v0, v2, p0}, Landroidx/core/view/x0;->f(Landroid/view/View;Lc0/f;Lc0/y;)V

    :cond_6
    iget p0, v0, Landroidx/viewpager2/widget/ViewPager2;->c:I

    if-lez p0, :cond_9

    new-instance p0, Lc0/f;

    invoke-direct {p0, v1}, Lc0/f;-><init>(I)V
    ...
    invoke-direct {v1, v5}, Lc0/f;-><init>(I)V

    invoke-static {v0, v1, p0}, Landroidx/core/view/x0;->f(Landroid/view/View;Lc0/f;Lc0/y;)V
    ...
    invoke-direct {p0, v4}, Lc0/f;-><init>(I)V

    :goto_1
    invoke-static {v0, p0, v8}, Landroidx/core/view/x0;->f(Landroid/view/View;Lc0/f;Lc0/y;)V
